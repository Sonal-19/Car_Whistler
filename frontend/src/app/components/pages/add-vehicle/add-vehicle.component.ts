...
export class AddVehicleComponent implements OnInit {
  ...
  ChangeAddress(): void {
    ...
    if (!this.vehicleAdded) {
      SweetAlert.errorAlert("Error!", "Please add a vehicle number before before changing address.");
      return;
    }
    const initialState = { userId: this.userId };
  ...
  proceedToPayment(): void {
    ...
    // const totalAmount = (this.sticker_charge || 0) + (this.deliveryDetails?.delivery_charge || 0);
    ...
    console.log("Proceeding to payment with:", reqBody);
